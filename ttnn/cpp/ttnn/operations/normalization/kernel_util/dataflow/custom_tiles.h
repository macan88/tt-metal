 ...
 * @param tile_height Height of the tile (e.g. from tensor tile shape)
 * @param tile_width Width of the tile (e.g. from tensor tile shape)
 */
FORCE_INLINE void generate_partial_reduce_scaler(
    ...
    // Iterate over faces (tile dimensions from caller for TinyTile support)
    if (scaler_uint16 != 0) {
