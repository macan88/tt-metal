...
struct SystemMemoryCQInterface {
    ...
    SystemMemoryCQInterface(ContextId context_id, uint16_t channel, uint8_t cq_id, uint32_t cq_size, uint32_t cq_start);
    ...
    const ContextId context_id_ = SILICON_CONTEXT_ID;
