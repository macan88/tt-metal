...
uint32_t get_profiler_dram_bank_size_per_risc_bytes(ContextId context_id) {
...
ProfilerStateManager::ProfilerStateManager(ContextId context_id) : context_id_(context_id), do_sync_on_close(true) {}
