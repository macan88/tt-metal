...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            'pytest models/demos/stable_diffusion_xl_base/tests/test_sdxl_perf.py::test_refiner_unet -k "1024x1024"',
        ...
        (
            'pytest models/demos/stable_diffusion_xl_base/tests/test_sdxl_perf.py::test_refiner_unet -k "512x512"',
        ...
        (
            "pytest models/demos/stable_diffusion_xl_base/vae/tests/pcc/test_module_tt_autoencoder_kl.py::test_vae -k 'test_1024x1024_decode'",
            663_083_865,
            "sdxl_vae",
        ...
        (
            "pytest models/demos/stable_diffusion_xl_base/vae/tests/pcc/test_module_tt_autoencoder_kl.py::test_vae -k 'test_512x512_decode'",
            171_560_642,
            "sdxl_vae",
        ...
        (
            "pytest models/demos/stable_diffusion_xl_base/vae/tests/pcc/test_module_tt_autoencoder_kl.py::test_vae -k 'test_1024x1024_encode'",
            324_271_938,
            "sdxl_vae",
        ...
        (
            "pytest models/demos/stable_diffusion_xl_base/vae/tests/pcc/test_module_tt_autoencoder_kl.py::test_vae -k 'test_512x512_encode'",
            83_537_085,
            "sdxl_vae",
        ...
        (
            "pytest models/demos/stable_diffusion_xl_base/tests/pcc/test_sdxl_clip_encoders.py::test_clip_encoder -k 'encoder_1'",
            13_112_562,
            "sdxl_clip_encoder_1",
            "sdxl_clip_encoder_1",
        ...
        (
            "pytest models/demos/stable_diffusion_xl_base/tests/pcc/test_sdxl_clip_encoders.py::test_clip_encoder -k 'encoder_2'",
