...
void RecordDispatchData(
    ...
    tt_metal::ContextId context_id = tt_metal::SILICON_CONTEXT_ID);
...
void RecordProgramRun(uint64_t program_id, tt_metal::ContextId context_id = tt_metal::SILICON_CONTEXT_ID);
